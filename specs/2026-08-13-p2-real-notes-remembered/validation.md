...
quietly acquire a clock in P5 or P8 and turn every future test into one that needs fake timers.
...
- Search, tags, markdown, or checkboxes (**P7**, **P8**).
- A theme toggle or a designed dark mode (**P9**).
- An empty state, spring motion on add and delete, a delete confirmation, or the 100-note
  performance check (**P10**).
