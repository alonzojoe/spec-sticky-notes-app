...
quietly acquire a clock in P5 or *Markdown and checkboxes* and turn every future test into one that needs fake timers.
...
- Search, tags, markdown, or checkboxes (**P9**, ***Markdown and checkboxes***).
- A theme toggle or a designed dark mode (***Dark mode***).
- An empty state, spring motion on add and delete, a delete confirmation, or the 100-note
  performance check (***Polish***).
