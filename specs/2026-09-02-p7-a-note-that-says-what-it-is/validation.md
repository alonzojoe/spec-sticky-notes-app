...
```
grep -rln "P7 · Find things\|P9 · Markdown\|*Markdown and checkboxes* · Dark mode\|*Dark mode* · Polish" specs/ \
...
and the 100+ note drag check. Both belong to *Dark mode* and neither is touched here.
